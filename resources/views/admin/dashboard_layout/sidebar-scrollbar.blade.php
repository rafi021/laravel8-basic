                    ...
                    <li class="has-sub">
                        ...
                        <ul class="collapse" id="components">
                            <div class="sub-menu">
                                ...
                                <li>
                                    <a href="button-social.html"
                                        >Button Social</a
                                    >
                                </li>

                                <li>
                                    <a href="button-loading.html"
                                        >Button Loading</a
                                    >
                                </li>
            ...
            <ul class="collapse" id="documentation" data-parent="#sidebar-menu">
                <div class="sub-menu">
                    ...
                    <li class="has-sub">
                        ...
                        >
                            <span class="nav-text">Layout Headers</span>
                            <b class="caret"></b>
                        </a>
                    ...
                    <li class="has-sub">
                        ...
                        >
                            <span class="nav-text">layout Sidebars</span>
                            <b class="caret"></b>
                        </a>
                        <ul class="collapse" id="sidebar-navs">
                            <div class="sub-menu">
                                ...
                                <li>
                                    <a href="sidebar-minimized.html"
                                        >Sidebar Minimized</a
                                    >
                                </li>

                                <li>
                                    <a href="sidebar-offcanvas.html"
                                        >Sidebar Offcanvas</a
                                    >
                                </li>
                                ...
                                <li>
                                    <a href="sidebar-with-footer.html"
                                        >Sidebar With Footer</a
                                    >
                                </li>

                                <li>
                                    <a href="sidebar-without-footer.html"
                                        >Sidebar Without Footer</a
                                    >
                                </li>
