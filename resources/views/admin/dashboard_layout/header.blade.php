            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li>
                            <a href="#">
                                <i class="mdi mdi-account-remove"></i> User
                                deleted
                                <span
                                    class="
                                        font-size-12
                                        ...
                                        float-right
                                    "
                                    ><i class="mdi mdi-clock-outline"></i> 07
                                    AM</span
                                >
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="mdi mdi-chart-areaspline"></i> Sales
                                report is ready
                                <span
                                    class="
                                        font-size-12
                                        ...
                                        float-right
                                    "
                                    ><i class="mdi mdi-clock-outline"></i> 12
                                    PM</span
                                >
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="mdi mdi-account-supervisor"></i> New
                                client
                                <span
                                    class="
                                        font-size-12
                            ...
                            <a href="#">
                                ...
                                <span
                                    class="
                                        ...
                                        float-right
                                    "
                                    ><i class="mdi mdi-clock-outline"></i> 05
                                    AM</span
                                >
                            </a>
                        </li>
