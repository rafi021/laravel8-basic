            ...
            <div class="card-body slim-scroll">
                ...
                >
                    ...
                    <div class="media-body pr-3">
                        <a class="mt-0 mb-1 font-size-15 text-dark" href="#"
                            >New Order</a
                        >
...
<div class="row">
    <div class="col-xl-6">
        <!-- To Do list -->
        <div
            class="card card-default todo-table"
            id="todo"
    ...
    <div class="col-xl-6">
        ...
        <div class="card card-default">
            <div class="card-header d-block d-md-flex justify-content-between">
                ...
                <div
                    class="dropdown show d-inline-block widget-dropdown ml-auto"
                >
                    <a
                        ...
                        <ul class="d-flex flex-column justify-content-between">
                            <li class="mb-2">
                                <i
                                    ...
                                    style="color: #29cc97"
                                ></i
                                >America <span class="float-right">5k</span>
                            </li>
                            <li>
                                <i
                                    class="
                                    ...
                                    style="color: #4c84ff"
                                ></i
                                >Australia <span class="float-right">3k</span>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="d-flex flex-column justify-content-between">
                            <li class="mb-2">
                                <i
                                    ...
                                    style="color: #ffa128"
                                ></i
                                >Europe <span class="float-right">4k</span>
                            </li>
                            <li>
                                <i
                                    class="
                                    ...
                                    style="color: #fe5461"
                                ></i
                                >Africa <span class="float-right">2k</span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="media">
                                    <div
                                        class="media-image mr-3 rounded-circle"
                                    >
                                        <a href="profile.html"
                                            ><img
